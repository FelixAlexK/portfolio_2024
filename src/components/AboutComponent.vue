...
<template>
  <section v-once class="">
    <div class="flex w-full flex-col gap-12 md:flex-row md:gap-24">
      <div class="flex w-full flex-col md:w-1/3">
        <h2 class="mb-8 font-lato text-4xl font-semibold md:text-6xl">Hi, ich bin Felix</h2>
        <picture>
          <!-- Modern format (WebP) -->
          <source
      ...
      <div class="flex w-full flex-col gap-8 md:mt-8 md:w-2/3 md:gap-16">
        <span class="font-rubik text-xl leading-8 md:text-2xl"
          ...
          Leidenschaft für technologische Herausforderungen mit kreativem Denken zu verbinden.</span
        >
