  ...
  >
    ...
    <nav class="hidden md:flex">
      <ul class="flex items-center gap-12 font-rubik text-lg font-semibold">
        <li>
          <a
            :class="{ 'text-blue-500': homeTarget }"
            class="px-6 hover:text-blue-500"
            href="#"
            >Home</a
          >
        </li>
        <li>
          <a
            :class="{ 'text-blue-500': aboutTarget }"
            class="px-6 hover:text-blue-500"
            href="#about"
            >Ich</a
          >
        ...
        <li>
          <a
            :class="{ 'text-blue-500': contactTarget }"
            class="px-6 hover:text-blue-500"
            href="#contact"
            >Kontakt</a
          >
    ...
    <div class="relative z-50 md:hidden">
      ...
      <transition name="fade-slide">
        ...
        >
          ...
          <button
            @click="closeMenu"
            class="absolute right-4 top-4 rounded-md text-2xl text-white focus:outline-none"
            aria-label="Toggle Menu"
          >
            <X class="h-10 w-10"> </X>
          </button>
          ...
          <ul class="mt-16 flex flex-col gap-8 font-rubik text-2xl">
            <li>
              <a class="p-6 hover:text-blue-500" @click="closeMenu" href="#"
                >Home</a
              >
            </li>
            <li>
              <a
                class="p-6 hover:text-blue-500"
                @click="closeMenu"
                href="#about"
                >Ich</a
              >
